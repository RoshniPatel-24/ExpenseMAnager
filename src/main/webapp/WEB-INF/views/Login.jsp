...
<head>
 ...
 <title>Expense Manager	|	Login Page</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form  action="authentication" method ="post"  class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <p class="small mb-0">Forget Password? <a href="forgetpassword">Forget Password</a></p>
